...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <style type="text/css">
        body {
            overflow:hidden;
           background: #595959;
           text-shadow:1px 0.5px 0 white,2px 2px 4px gray;
            font-weight:bolder;
            color:gray;
        }
         /*//-ms代表【ie】内核识别码
...
z-index: 5;
            ...
            #belly .textbox {
                box-shadow:1px 1px 0 white,3px 3px 0 gray;
                border-radius:5px;
                width:148px;
                height:19px;           
        }
...
<body>
    ...
    <img src="../image_source1/img1.jpg" id="img1" class="hide"/>
    <img src="../image_source1/img2.jpg" id="img2" class="hide"/>
    <img src="../image_source1/img3.jpg" id="img3" class="hide"/>
    <img src="../image_source1/img4.jpg" id="img4" class="hide"/>
    <img src="../image_source1/img5.jpg" id="img5" class="hide"/>
    <img src="../image_source1/img6.jpg" id="img6" class="hide"/>
    <img src="../image_source1/img7.jpg" id="img7" class="hide"/>
    <img src="../image_source1/img8.jpg" id="img8" class="hide"/>
    <img src="../image_source1/img9.jpg" id="img9" class="hide"/>
    <img src="../image_source1/img10.jpg" id="img10" class="hide"/>
    <img src="../image_source1/img11.jpg" id="img11" class="hide"/>
    <img src="../image_source1/img12.jpg" id="img12" class="hide"/>
    <img src="../image_source1/img13.jpg" id="img13" class="hide"/>
    <div id="container" style="border:; border-color: inherit; border-width: 1px; width:350px;height:643px;margin:0 auto;">
        <div id="theTip" style="height:90px;width:350px;border:;position:absolute;">
           <div id="message_box" style="height:60px;width:200px;border:;background-color:red;position:absolute;margin-top:20px;margin-left:170px;border-radius:0px 10px 0px 10px;background-color:white;opacity:0.7;">
               <p style="border:;margin-top:2px;padding-left:5px;padding-right:2px;color:red;text-shadow:1px 0.5px 0 white,2px 2px 4px red;">管理员请登录，学生用户请单击我的头= .=</p>
           </div>
...
<div id="belly">
    ...
    <form id="form1" runat="server">  
        <table id="login">
        <tr>
            <td colspan="2" style="text-align:center;">管理员登录</td>
        </tr>
        <tr>
...
<script type="text/javascript">
        ...
        /*控制背景切换*/
        function slide() {
            var next = get_random(1, 11);
            while (next == show) {
                next = get_random(1, 11);
            }
